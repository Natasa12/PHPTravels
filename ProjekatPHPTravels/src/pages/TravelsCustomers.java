...
public class TravelsCustomers extends BasicPage {
	...
	private By fname = By.cssSelector("[name='fname']");
	private By lname = By.cssSelector("[name='lname']");
	private By email = By.cssSelector("[name='email']");
	private By password = By.cssSelector("[name='password']");
	private By mobile = By.cssSelector("[name='mobile']");
	...
	private By checkbox = By.cssSelector("input.checkbox");
	private By submit = By.cssSelector("button.btn.btn-primary");

	
	private By search = By.cssSelector("a.xcrud-search-toggle.btn.btn-default");
	...
	{
		this.driver.findElement(this.search).sendKeys("Natasa");
